...
export function BlocksLoginPage({
  ...
  const resolvedKeywords = useMemo(
    () => derivedKeywords.length > 0 ? derivedKeywords : keywords,
  ...
  return (
    <div className="blocksLogin-page">
      ...
      <div
        className="particle"
        style={{ left: "6%", animationDuration: "16s", animationDelay: "0s", width: 2, height: 2 }}
      />
      <div
        className="particle"
        style={{ left: "18%", animationDuration: "20s", animationDelay: "3s", width: 1.5, height: 1.5 }}
      />
      <div
        className="particle large"
        style={{ left: "35%", animationDuration: "14s", animationDelay: "1.5s", width: 3, height: 3 }}
      />
      <div
        className="particle"
        style={{ left: "52%", animationDuration: "18s", animationDelay: "5s", width: 2, height: 2 }}
      />
      <div
        className="particle"
        style={{ left: "68%", animationDuration: "22s", animationDelay: "2s", width: 1, height: 1 }}
      />
      <div
        className="particle large"
        style={{ left: "82%", animationDuration: "15s", animationDelay: "4s", width: 2.5, height: 2.5 }}
      />
      <div
        className="particle"
        style={{ left: "92%", animationDuration: "19s", animationDelay: "6s", width: 1.5, height: 1.5 }}
      />
                ...
                <div className="sdk-card" key={`${p.name}-${i}`}>
                  ...
                  {p.url && (
                    <div className="sdk-card-footer">
                      <a href={p.url} target="_blank" rel="noreferrer" className="sdk-cta">
                        {p.cta}
